...
public class ComingMovieFragment extends Fragment {
    ...
    SwipeRefreshLayout swipe_refresh_coming_movie;
    RecyclerView recyclerView;
    private ComingMovieListAdapter mAdapter;
    private List<MovieData> mMovieData;

    RecyclerView.LayoutManager mLayoutManager;
    //GridLayoutManager mLayoutManager2;

    public ComingMovieFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_coming_movie, container, false);
        recyclerView = (RecyclerView) rootView.findViewById(R.id.coming_recycler_view);
        swipe_refresh_coming_movie = (SwipeRefreshLayout) rootView.findViewById(R.id.swipe_refresh_coming_movie);
        swipe_refresh_coming_movie.setColorSchemeColors(getResources().getColor(R.color.colorAccent), getResources().getColor(R.color.colorPrimaryDark), getResources().getColor(R.color.colorFloatButtonv1));
        new GetUpComingFilm().execute("1");
        return rootView;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        swipe_refresh_coming_movie.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
    ...
    private class GetUpComingFilm extends AsyncTask<String, Void, String> {
        @Override
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                mAdapter = new ComingMovieListAdapter(mMovieData, getContext(), (AppCompatActivity) getActivity());
                recyclerView.setAdapter(mAdapter);
                swipe_refresh_coming_movie.setRefreshing(false);
        ...
        protected String doInBackground(String... strings) {
            ...
            String page = "page=";
            String url = "https://api.themoviedb.org/3/movie/upcoming?" + api_key + "&" + language + "&" + page;
            try {
